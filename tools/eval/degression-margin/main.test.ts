...
describe('Abnahmetest F2 (Spec 06 §7.2)', () => {
  ...
  it('liegt in der von Spec 02 §5.8.4 hergeleiteten Groessenordnung', () => {
    // Getrennte Schwellen, da das feine Gitter (lambda knapp ueber 1) eine deutlich
    // knappere, aber gueltige Marge liefert als der Grenzfall grosser Spruenge (lambda = 9).
    expect(artefakt.margin_min).toBeGreaterThan(1);
