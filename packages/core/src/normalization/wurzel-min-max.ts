...
//   w(x) = sign(x) * sqrt(|x|).
// Fuer rechtsschiefe, nichtnegative Rohgroessen (E-07): Die Wurzel staucht den oberen
// Randbereich, gleiche absolute Preisunterschiede schlagen unten staerker auf x_dach
// durch als oben — die lineare min-max-Abbildung behandelte beide gleich. Die
// vorzeichenerhaltende Fortsetzung haelt w auf ganz R streng monoton, damit der
// Registervertrag (I-22) ohne Sonderdomaene gilt. Umpolung wie bei min-max ueber
// vertauschte Grenzen (I-13); identische Grenzen sind S-01.
