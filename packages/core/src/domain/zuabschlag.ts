...
// Nachweis der Bereichsregel, aus der `faktor` stammt. Rein dokumentarisch: der Kern
...
export interface ZuAbschlag {
  ...
  // Regelnachweis auftreten, wenn das Merkmal der Regel an dieser Einheit keinen Wert hat.
