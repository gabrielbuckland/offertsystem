    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-20 border-b border-border bg-background">
        <div className="mx-auto flex h-12 w-full max-w-6xl items-center gap-6 px-8">
          ...
          {/* Kein eigener Einstellungen-Punkt: Einstellungen gelten je Ebene (firmenweit
              in der Projektuebersicht, projektbezogen im Projekt) und sind dort
              erreichbar, wo sie wirken. */}
