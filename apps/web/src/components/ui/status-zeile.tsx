/**
 * Ein Muster fuer Prozesszustaende («Speichert…», «Bewertungen werden bezogen…»).
 * CSS-Spinner statt Bibliothek; `role="status"` macht den Zustand fuer Screenreader
 * sichtbar, ohne wie ein Fehler zu unterbrechen.
 */
